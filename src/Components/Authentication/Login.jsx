        ...
        <div className="SignUppop-up">
            <div className="SignUpinput-box">
                ...
                <ul className="social-network social-circle">
                    <li > <a href=" " onClick={signInWithFacebook} id="facebooklog" class="icon-facebook"> <i className="fab fa-facebook-f"></i>   </a></li>
                    <li ><a href=" " onClick={signInWithGoogle} id="googlelog" class="icon-google"><i className="fab fa-google"></i></a></li>
                </ul>
