            ...
            <footer className="bg_image bg_image--1 bg-black text-center text-lg-start" data-black-overlay="6">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li className="mb-md-3">
                                    <i className="fas fa-map-marker-alt"></i><a href="/connect.html#map2" className="ml-2">OP-
                                    Kolkata, West Bengal,
                                    India</a>
                                </li>
                                <li>
                ...
                <div className="container p-4 pb-0 text-center">
                    ...
                    <section className="mb-4">
                        {/* <!-- Facebook --> */}
                        <a className="btn btn-primary btn-floating m-1 btn-lg icon-facebook"
                            href="https://www.facebook.com/prodgspeople" target="_blank" rel="noreferrer" role="button">
                            <i className="fab fa-facebook-f fa-lg"></i>
                        </a>

                        {/* <!-- Instagram --> */}
                        <a className="btn btn-primary btn-floating m-1 btn-lg icon-instagram"
                            href="https://www.instagram.com/prodgspeople" target="_blank" rel="noreferrer" role="button">
                            <i className="fab fa-instagram fa-lg"></i>
                        </a>

                        {/* <!-- Youtube --> */}
                        <a className="btn btn-primary btn-floating m-1 btn-lg icon-youtube"
                            href="https://www.youtube.com/channel/UCpI8MnHEA1KXE2qxw7YgqIA" target="_blank" rel="noreferrer"
                            role="button">
                            <i className="fab fa-youtube fa-lg"></i>
                        </a>

                        {/* <!-- Twitter --> */}
                        <a className="btn btn-primary btn-floating m-1 btn-lg icon-twitter"
                            href="https://twitter.com/prodgspeople" target="_blank" rel="noreferrer" role="button">
                            <i className="fab fa-twitter fa-lg"></i>
                        </a>

                        {/* <!-- Pinterest --> */}
                        <a className="btn btn-primary btn-floating m-1 btn-lg icon-pinterest"
                            href="https://in.pinterest.com/prodgspeople" target="_blank" rel="noreferrer" role="button">
                            <i className="fab fa-pinterest fa-lg"></i>
                        </a>

                        {/* <!-- Tumblr --> */}
                        <a className="btn btn-primary btn-floating m-1 btn-lg icon-tumblr"
                            href="https://prodgspeople.tumblr.com" target="_blank" rel="noreferrer" role="button">
                            <i className="fab fa-tumblr fa-lg"></i>
                        </a>

                        {/* <!-- Quora --> */}
                        <a className="btn btn-primary btn-floating m-1 btn-lg icon-quora"
                            href="https://www.quora.com/profile/The-Prodigious-People" target="_blank" rel="noreferrer"
                            role="button">
                            <i className="fab fa-quora fa-lg"></i>
                        </a>

                        {/* <!-- Linkedin --> */}
                        <a className="btn btn-primary btn-floating m-1 btn-lg icon-linkedin"
                            href="https://www.linkedin.com/company/theprodigiouspeople" target="_blank" rel="noreferrer"
                            role="button">
                        ...
                        <form action="">
                            ...
                            <div className="row d-flex justify-content-center">
                                ...
                                <div className="col-auto">
                                    <button type="submit" className="btn btn-outline-light mb-4 subs-submit">
                                        Subscribe
                                </button>
                                </div>
                            </div>
